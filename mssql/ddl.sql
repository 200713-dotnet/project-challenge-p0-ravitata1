...
alter table Pizza.PizzaTopping
  add constraint PK_PizzaTopping_PizzaId foreign key (PizzaId) references Pizza.Pizza(PizzaId)
  go

alter table Pizza.PizzaTopping
  add constraint PK_PizzaTopping_ToppingId foreign key (ToppingId) references Pizza.Topping(ToppingId)
  go
